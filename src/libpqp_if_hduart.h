...
#ifndef LIBPQP_IF_HDUART_H
#define LIBPQP_IF_HDUART_H
...
extern void PQP_IF_OBJ_INITIALIZER_HDUART1( pqp_interface_t * pqp_interface );
#endif

#if defined( LIBPQP_HAS_HDUPLEX_UART2 )
extern void PQP_IF_OBJ_INITIALIZER_HDUART2( pqp_interface_t * pqp_interface );
#endif

#endif //LIBPQP_IF_HDUART_H
